...
def handler(event: dict, context) -> dict:
    ...
    if action == "list":
        ...
        # Приоритет по городу: сначала город пользователя, затем соседние
        # Карта ближайших городов (упорядочена по близости)
        NEARBY = {
            "Тобольск": ["Тюмень", "Ялуторовск", "Ишим", "Омск", "Нижневартовск", "Сургут"],
            "Тюмень": ["Тобольск", "Ялуторовск", "Ишим", "Омск", "Екатеринбург", "Сургут"],
            "Омск": ["Тюмень", "Новосибирск", "Тобольск", "Ишим", "Барнаул"],
            "Новосибирск": ["Томск", "Барнаул", "Омск", "Кемерово", "Новокузнецк"],
            "Екатеринбург": ["Тюмень", "Челябинск", "Пермь", "Нижний Тагил", "Каменск-Уральский"],
            "Москва": ["Подольск", "Химки", "Балашиха", "Мытищи", "Одинцово", "Санкт-Петербург"],
            "Санкт-Петербург": ["Москва", "Великий Новгород", "Псков", "Выборг"],
            "Казань": ["Нижний Новгород", "Уфа", "Самара", "Набережные Челны", "Чебоксары"],
            "Уфа": ["Казань", "Самара", "Стерлитамак", "Оренбург", "Челябинск"],
            "Краснодар": ["Сочи", "Ростов-на-Дону", "Новороссийск", "Ставрополь"],
            "Ростов-на-Дону": ["Краснодар", "Таганрог", "Шахты", "Новочеркасск"],
            "Нижний Новгород": ["Казань", "Владимир", "Иваново", "Дзержинск", "Арзамас"],
            "Красноярск": ["Абакан", "Иркутск", "Кемерово", "Лесосибирск"],
            "Иркутск": ["Красноярск", "Улан-Удэ", "Ангарск", "Братск"],
            "Владивосток": ["Находка", "Хабаровск", "Уссурийск"],
            "Хабаровск": ["Владивосток", "Биробиджан", "Комсомольск-на-Амуре"],
            "Сургут": ["Нижневартовск", "Нефтеюганск", "Ханты-Мансийск", "Тюмень"],
            "Пермь": ["Екатеринбург", "Ижевск", "Кунгур", "Соликамск"],
            "Волгоград": ["Саратов", "Астрахань", "Камышин"],
        ...
        if user_city and user_city not in ("Все города", "") and sort_by == "date":
            ...
            # CASE: 0 = мой город, 1..N = соседние по порядку, 999 = остальные
            city_cases = [f"WHEN a.city ILIKE '%{safe_city}%' THEN 0"]
            for i, nc in enumerate(nearby[:5], start=1):
                safe_nc = nc.replace("'", "''")
                city_cases.append(f"WHEN a.city ILIKE '%{safe_nc}%' THEN {i}")
