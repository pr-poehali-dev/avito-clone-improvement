...
export default function BottomNav({ activePage, onNavigate, user, onAuthClick, unreadMsgs }: BottomNavProps) {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-border/50 safe-area-bottom">
