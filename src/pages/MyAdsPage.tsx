...
import { myAds, createAd, deleteAd, pauseAd, markSold, Ad, formatTimeAgo } from "@/lib/adsApi";
...
function SoldDialog({ ad, onConfirm, onClose }: {
  ad: Ad;
...
function MyAdCard({ ad, onDelete, onPause, onMarkSold, onNavigate, className }: {
  ad: Ad;
